...
address: "Nebraska Union - Platte River Room South, 1400 R St, Lincoln, NE 68588"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "January 6-7, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:30 am - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-01-06      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-01-07        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Tom Lynch", "Michael Robinson", "Greg Woodward"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Carrie Brown", "Adam Caprez", "Emelie Harstad", "Natasha Pavlovikj", "Hongfeng Yu", "Caughlin Bohn"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<center><form><button name="button" style="background-color: D71920; padding: 15px 32px" formaction="https://marketplace.unl.edu/default/hcc-python-data-analysis-2020.html">Register to Attend</button></form></center>
<p><br></p>
